...
from src.verl.utils.reward_score.if_eval import evaluation_lib

_INPUT_DATA = flags.DEFINE_string(
    "input_data", None, "path to input data", required=True
)

eval_data_path = "/share/project/weiyifan/ReSearch/scripts/evaluation/eval_results/IFEval_2025_07_09_16_44_mutorl/intermediate_data.json"
print("eval_data_path: ", eval_data_path)

_INPUT_RESPONSE_DATA = flags.DEFINE_string(
    "input_response_data", eval_data_path, "path to input response data", required=False
)
...
def main(argv):
    ...
    prompt_to_response = evaluation_lib.mutorl_read_prompt_to_response_dict(
